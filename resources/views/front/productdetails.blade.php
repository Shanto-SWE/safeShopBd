			...
			<div class="span6">
				...
				<hr class="soft"/>
				  ...
				  <form method="post" action="{{route('cart.store')}}">
							...
							@else
								<button class="btn btn-large btn-primary pull-right"><a style="color: #fff;text-decoration: none;" href="{{route('user.login')}}"> Add to cart <i class=" icon-shopping-cart"></i></a></button>
							@endif
						</form>
				  </div>
		...
		<hr class="soft"/>
			...
			<div class="tab-pane active" id="blockView">
				...
				@foreach($related_products as $related_product)
					<li class="span3">
					  <div class="thumbnail">
						<a href="{{route('productView',$related_product->id)}}"><img class="relatedImg" src="{{asset('uploads/'.$related_product->image)}}" height="60px" alt=""/></a>
						<div class="caption">
