...
<div class="span9">		
				  ...
				  <ul class="thumbnails">
				  	@foreach($product as $value)
						<li class="span3">
						  <div class="thumbnail">
						  <i class="tag"></i>
							<a href="{{route('productView',$value->id)}}"><img class="FeaturedImage" src="{{asset('uploads/'.$value->image)}}" alt=""></a>
							<div class="caption">
							  <h5>{{$value->name}}</h5>
		...
		<h4>Latest Products </h4>
			  ...
			  @foreach($new_products as $new_product)
				<li class="span3">
				  <div class="thumbnail">
					<a  href="{{route('productView',$new_product->id)}}"><img class="latestImage" src="{{asset('uploads/'.$new_product->image)}}" alt=""/></a>
					<div class="caption">
					  <h5 class="text-center">{{$new_product->name}}</h5>
