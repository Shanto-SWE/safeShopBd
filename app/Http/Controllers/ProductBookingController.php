...
class ProductBookingController extends Controller
{
    ...
    {
        $bookingproduct=ProductBooking::get();
        return view('admin.bookedProducts.index',compact('bookingproduct'));
    }
...
public function ewayPayment($amount){
    ...
    $apiKey = '44DD7Cc2wWuCR0ZndTZl4eyNAxMZP+BHHfghu/LbKJfylAejzH4tCFF1z/ZyZbpWMPeD+Y';
    $apiPassword = 'fUVMdvcs';
    $apiEndpoint = 'Sandbox';
    ...
    $transaction = [
        ...
        'Payment' => [
            'TotalAmount' => $total_amount*100/84.92,
        ],
